  ...
  return (
    <html lang="pt-BR" data-theme="light" suppressHydrationWarning>
      ...
      >
        ...
        <footer className="footer footer-center p-10 bg-base-300 text-base-content rounded-none border-t-4 border-base-content">
          ...
          <div>
            <p className="font-bold">
              Pixel Eucarístico <br/>
              <span className="font-normal text-sm">williancustodioquintino@gmail.com | (19) 99226-4821</span>
            </p>
