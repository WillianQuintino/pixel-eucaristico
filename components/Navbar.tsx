  ...
  return (
    <div className="navbar bg-base-100 border-b-4 border-base-content sticky top-0 z-50 text-base-content">
      ...
      <div className="navbar-end flex items-center gap-2">
        <a href="https://github.com/Pixel-Eucaristico" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle border-2 border-base-content shadow-[2px_2px_0_0_currentColor] rounded-none" aria-label="GitHub">
